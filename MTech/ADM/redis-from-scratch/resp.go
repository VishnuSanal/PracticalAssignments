...
func NewResponse(reader io.Reader) *Response {
	return &Response{reader: bufio.NewReader(reader)}
}
...
func (response *Response) readArray() (Value, error) {
	value := Value{}
	value.typ = "array"

	// read length of array
	len, _, err := response.readInteger()
	if err != nil {
		return value, err
	}
...
func (response *Response) readBulk() (Value, error) {
	value := Value{}
